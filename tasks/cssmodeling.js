...
module.exports = function (grunt) {
    ...
    grunt.registerMultiTask( 'cssmodeling', 'model CSS systems', function () {
        ...
        var imports = {
          scss: "/* GENERATED BY CSSMODELER */\n",
          less: "/* GENERATED BY CSSMODELER */\n",
          css: "/* GENERATED BY CSSMODELER */\n"
        };
        if ( options.imports ) {
          if ( options.imports.scss ) {
            imports.scss += options.imports.scss;
          }
          if ( options.imports.less ) {
            imports.less += options.imports.less;
          }
          if ( options.imports.css ) {
            imports.css += options.imports.css;
          }
        }
